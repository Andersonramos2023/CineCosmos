...
const routes = [
...

  {
    path:'/todos/tv/:tvId',
    name:'tvDetailsTodos',
    component: () => import('@/views/Todos/TvDetailsView.vue'),
    props: route => ({ tvId: Number(route.params.tvId) })
  },
...

  {
    ...
    component: () => import('@/views/Ficção/Aventuraviews/TvDetailsAventuraView.vue'),
    props: route => ({ tvId: Number(route.params.tvId) })
  },
...

  {
    ...
    component: () => import('@/views/Fantasia/Fantasiaviews/TvDetailsFantasiaView.vue'),
    props: route => ({ tvId: Number(route.params.tvId) })
  },
