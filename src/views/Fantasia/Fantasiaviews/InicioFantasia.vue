...
<template>
  <HomeFantasia>
    ...
    <h2>Esta pronto para fantasia?</h2>
    ...
    <h2>Pronto para uma explosão de cores e diversão?</h2>
    <div class="lista">
    ...
    <h2>O conhecimento nos espera!</h2>
    <div class="lista">
...
.card img {
  width: 100%;
  border-bottom: 2px solid #37746f;
  border-radius: 10px;
}
